...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tModalMain = '<div id="' + $h.MODAL_ID + '" class="file-zoom-dialog modal fade"   style = "z-index: -1;" '  + 
                'aria-labelledby="' + tModalLabel + '" {tabIndexConfig}  > </div>' ;
            tModal = '<div class="modal-dialog modal-lg{rtl}" role="document" style = "z-index: - 1;">\n' +
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'genric-btn primary radius',
                    ...
                    zoomClass: 'genric-btn primary radius',
    ...
    $.fn.fileinput.defaults = {
        ...
        browseClass: 'genric-btn primary radius',
        removeIcon: '<i class="bi-trash"></i>',
        removeClass: /*defBtnCss1*/'genric-btn danger radius',
