...
router.get('/view/writing-post', async function (req, res) {
    ...
    var obj = require('../assets/json_file/test_postdata.json')
    var nPages = 1
    res.render('vwWriter/writing/writing-posts', {
        layout: 'writer.hbs',
        db: obj,
...
router.get('/edit/draft-post', async function (req, res) {
    var id = req.query.id;
    var obj = {
        "id": 0,
        "title": "Thiếu úy công an bắt quả tang nghi can định vứt bỏ ma túy đá",
...
router.post('/del/draft-post/:id', function (req, res) {
    var id = req.params.id;
    console.log(id)
})
...
router.get('/edit/reject-post', async function (req, res) {
    id = req.query.id
